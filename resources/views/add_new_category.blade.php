...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <title>Add New Student Category </title>
            ...
            <div class="container page__container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form method="POST" action="{{ route('addStudentCategory') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                    ...
                                    <div class="form-group m-0" role="group" aria-labelledby="label-topic">
                                        <div class="form-row align-items-center">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <span id="title-error" class="error text-danger" style="display:none;">Select a Task Category</span>   
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-row align-items-center">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control custom-select w-auto" name="parent_id" id="parent_id">
                                                    ...
                                                    <option value="{{ $module->id }}">{{ $module->category_name}}</option> 
                                                    @endforeach
                                                </select>
                                                <span id="module-error" class="error text-danger" style="display:none;">Sub-Module is required.</span>   
                                            </div>
                                        </div>
                                    </div>
                                </div>
