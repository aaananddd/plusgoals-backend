                ...
                <div class="container page__container">
                    ...
                    <div class="d-flex flex-column flex-lg-row align-items-center">
                        <div
                            ...
                            <h1 class="h2 mb-8pt">Other features</h1>
            ...
            <div class="container page__container">
                    ...
                    <div class="page-section">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-12 text-center">
                                        <div class="container">
                                            <div class="box div1">
                                                <a href="{{ route('listStudentCategory') }}">Student Categories</a>
                                            </div>
                                           
                                            <div class="box div2">
                                                <a href="{{ route('listTaskCategory') }}">Task Categories</a>
                                            </div> 

                                            <div class="box div3">
                                                <a href="{{ route('listLevels') }}">Levels</a>
                                            </div> 

                                            <div class="box div4">
                                                <a href="{{ route('listDifficultyLevels') }}">Difficulty Levels</a>
                                            </div> 
                                        </div>
                                    </div>
                                </div>
                ...
                <style>
                    ...
                    .box {
                        ...
                        padding: 40px; /* Adjust padding to make the box smaller */
                        border-radius: 10px;
