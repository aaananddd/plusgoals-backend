            ...
            <div class="container page__container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form method="POST" action="{{ url('update_module') }}/{{ $data->id }}" enctype="multipart/form-data">
                    
                                {{ csrf_field() }}
                                
                                <div class="form-group row">
                                    <label for="old_category_name" class="col-md-3 col-form-label form-label">Old Module Name</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="old_category_name" value="{{ $data->module_name }}" name="old_category_name">
                                    </div>
                                </div>
                                
                                <div class="form-group row">
                                    <label for="module_name" class="col-md-3 col-form-label form-label">New Module Name</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="module_name" placeholder="Enter new module name ..." name="module_name" required>
                                        <span id="title-error" class="error text-danger" style="display:none;">New module name is required.</span> 
                                    </div>
                                </div>
                                            ...
                                            <select class="form-control custom-select w-auto" name="topic" id="topic">
                                                <option value="option_select" disabled selected>Topic</option>
                                                    @foreach($topic as $topics)
                                                        <option value="{{ $topics->topic_id }}" {{old('topics', $data->topic) ==
                                                                    $topics->topic_id ? 'selected' : '' }}>
                                                                    {{ $topics->topic_name }}
                                                        </option>
                                                    @endforeach
                                            </select>
                                ...
                                <div class="form-group row">
                                    <label id="label-topic" for="parent_id" class="col-md-3 col-form-label form-label">Sub-Topic of</label>
                                        <div class="col-md-9">
                                            <select class="form-control custom-select w-auto" name="parent_id" id="parent_id">
                                                <option value="option_select" disabled selected>Sub Topic of</option>
                                                    @foreach($moduleList as $modules)
                                                        <option value="{{ $modules->id }}" {{old('modules', $data->module_name) ==
                                                                    $modules->id ? 'selected' : '' }}>
                                                                    {{ $modules->module_name }}
                                                        </option>
                                                    @endforeach
