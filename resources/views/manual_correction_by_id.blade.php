...
<head>
    ...
    <title>Manual Correction for Descriptive </title>
            ...
            <div class="page-section">
                <div class="container page__container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <form method="POST" action="{{ url('approve_descritpive', ['task_id' => $task->id]) }}">
                                    {{ csrf_field() }}
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="form-row align-items-center">
                                                <div class="col-md-4">
                                                    <span style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: bold; color: #333;">
                                                        Task Name :
                                                    </span>
                                                </div>
                                                <div class="col-md-8">
                                                    <span style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: light; color: #333;">
                                                        {{ $task->task_name }}
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="custom-control" style="text-align: center;">
                                            @if( $task->approve == 0)
                                            <label>
                                                <button type="button" data-approve="1" data-id="{{ $task->id }}" name="submit" id="submit" class="btn btn-primary me-sm-3 me-1 data-submit" style='margin-left:25%'>
                                                    Approve
                                                </button>
                                            </label>
                                            @else 
                                            <label>
                                                <button type="button" data-approve="0" data-id="{{ $task->id }}" name="submit" id="submit" class="btn btn-primary me-sm-3 me-1 data-submit" style='margin-left:25%'>
                                                    Reject
                                                </button>
                                            </label>
                                            @endif
                                    ...
                                    <h5 class="card-title"></h5>
                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><span style="font-weight: bold;">Difficulty</span></td>
                                                    <td>: &nbsp; {{ $task->difficulty }}</td>
                                                </tr>
                                                <tr>    
                                                    <td><span style="font-weight: bold;">Task Category</span></td>
                    ...
                    <script>
                       jQuery(document).ready(function($) {
                            $("#submit").click(function(e) {
                                ...
                                $.ajax({
                                        type: "POST",
                                        url: "{{ env('APP_URL') }}approve_descriptive/" + id, 
                                    ...
                                    success: function(data) {
                                        ...
                                        if(data.status === true){
                                            Swal.fire("Status updated", "", "success").then((result) => {
                                            if (result.isConfirmed) {
                                                window.location.href = '/get_descriptive';
                                            }
                                            });
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                window.location.href = '/get_descriptive_by_id/' + '{{ $task->id}}';
                                            }
                                           });
                                        }   
                                    },
