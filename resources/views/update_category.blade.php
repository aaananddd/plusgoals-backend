            ...
            <div class="container page__container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form method="POST" action="{{ url('update_student_category') }}/{{ $data->id }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body table--elevated">
                                    <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                        <div class="form-row align-items-center">
                                            <label id="label-title" for="new_category_name" class="col-md-3 col-form-label form-label">Module name</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="new_category_name" placeholder="{{ $categories->category_name }}" name="new_category_name" >
                                                <!-- <span id="title-error" class="error text-danger" style="display:none;">Modul name is required.</span> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="list-group-item">
                                    <div class="form-group m-0" role="group" aria-labelledby="label-topic">
                                        <div class="form-row align-items-center">
                                            <label id="label-topic" for="task_category" class="col-md-3 col-form-label form-label">Task Category</label>
                                            <div class="col-md-9">
                                                <div class="form-row align-items-center">
                                                    <div class="col-md-4">
                                                        <select class="form-control custom-select w-auto" name="task_category" id="task_category">
                                                            <option value="option_select" disabled selected>Task Category</option>
                                                            @foreach($task_category as $category)      
                                                            <option value="{{ $category->id }}">{{ $category->task}}</option> 
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <span style ="font-weight:bold">Previous task category &nbsp;: &nbsp;</span> <span> {{ $categories->task_category }} </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="list-group-item">
                                    <div class="form-group m-0" role="group" aria-labelledby="label-topic">
                                        <div class="form-row align-items-center">
                                            <label id="label-topic" for="topic" class="col-md-3 col-form-label form-label">Main/Sub Topic</label>
                                            <div class="col-md-9">
                                            <div class="form-row align-items-center">
                                                <div class="col-md-4">
                                                    <select class="form-control custom-select w-auto" name="topic" id="topic">
                                                        <option value="option_select" disabled selected>Topic</option>
                                                ...
                                                <div class="col-md-5">
                                                        <span style ="font-weight:bold">Previous Topic &nbsp;: &nbsp; </span> <span> {{ $categories->topic_name }} </span>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group" id="module-dropdown" style="display:none;">
                                <div class="list-group-item">
                                    <div class="form-group m-0" role="group" aria-labelledby="label-module">
                                        <div class="form-row align-items-center">
                                            <label id="label-module" for="parent_id" class="col-md-3 col-form-label form-label">Sub-Module</label>
                                            <div class="col-md-9">
                                            <div class="form-row align-items-center">
                                                <div class="col-md-4">
                                                    <select class="form-control custom-select w-auto" name="parent_id" id="parent_id">
                                                        <option value="option_select" disabled selected>Select Sub-Module</option>
                                                ...
                                                <div class="col-md-5">
                                                        <span style ="font-weight:bold">Previous Parent module &nbsp; : &nbsp; </span> <span> {{ $categories->parent }} </span>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
                        ...
                        <script>
                            $(document).ready(function() {
                                $('#topic').change(function() {
                                    ...
                                    if (selectedTopic == 2) { // Assuming topic_id = 2 requires the additional dropdown
                                        $('#module-dropdown').show();
                                    } else {
                                        $('#module-dropdown').hide();
                                    }
                                });
                            });
                        </script>
