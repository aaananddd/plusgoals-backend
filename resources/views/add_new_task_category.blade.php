...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <title>Add New Task Category </title>
            ...
            <div class="container page__container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form method="POST" action="{{ route('addTaskCategory') }}" enctype="multipart/form-data">
                    
                                {{ csrf_field() }}
                          
                                <div class="form-group row">
                                    <label for="category_name" class="col-md-3 col-form-label form-label">New Category Name</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="category_name" placeholder="Enter new category name ..." name="category_name" required>
