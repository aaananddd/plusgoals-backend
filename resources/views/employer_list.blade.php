            ...
            <div class="mdk-header__content">
                <div class="navbar navbar-expand navbar-light bg-white border-bottom" id="default-navbar" data-primary>
                    <div class="container page__container">
                        ...
                        <li class="nav-item dropdown ">
                            <a href="{{ route('GetEmployersList') }}" class="nav-link {{ Request::route()->getName() == 'GetEmployersList' ? 'active-tab' : '' }}">Employers</a>
                        </li>
                        <li class="nav-item dropdown ">
                            @if(Session::get('role') == 1)
                ...
                <div class="container page__container">
                    <div class="d-flex flex-column flex-lg-row align-items-center">
                        <div
                            ...
                            <div class="col-lg-8">
                                <h1 class="h2 mb-0">Employers list</h1><br>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all" id="myTable">
                                        @foreach ($data as $index => $employers)
                                        @php
                                        ...
                                        @endphp
                                            ...
                                            <td>{{ $employers->first_name }} {{ $employers->last_name }}</td>
                                            <td>{{$employers->designation }}</td>  
                                            <td>{{$employers->company_name }}</td>  
                                            <td>{{$employers->country }}</td>  
                                            <td>{{$employers->created_at->format('Y-m-d') }}</td>
                                            <td><button style="border-color: white; border: none; color:#1E90FF" 
                                            onClick="window.location.href = '{{ env('APP_URL') }}get_employer_by_id/<?php echo $employers->id; ?>'"><svg
                                                ...
                                                <td><button style="border-color: white; border: none; color:#1E90FF" 
                                                        onClick="window.location.href = '{{ env('APP_URL') }}request_for_intern_contact/<?php echo $employers->id; ?>'">
                                                        <i class="fa fa-phone" style="font-size:28px; color:#4da6ff; background-color:transparent; "></i>

                                                </button></td>
                                                <td><button style="border-color: white; border: none; color:#1E90FF" 
                                                        onClick="window.location.href = '{{ env('APP_URL') }}list_employer_tasks/<?php echo $employers->id; ?>'">
                                                         <i class='fas fa-tasks' style='font-size:28px; color:#4da6ff; background-color:transparent; '></i>
                                                </tr>
