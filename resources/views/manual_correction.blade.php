                ...
                <div class="navbar navbar-expand navbar-light bg-white border-bottom" id="default-navbar" data-primary>
                    <div class="container page__container">
                        ...
                        <li class="nav-item dropdown ">
                            ...
                            <a href="{{ route('GetDescriptiveAnswer') }}" class="nav-link {{ Request::route()->getName() == 'tasksPendingForApproval' ? 'active' : '' }}">Pending Tasks</a>
                            @endif
                        </li>
                    </ul>
                ...
                <div class="container page__container">
                    <div class="d-flex flex-column flex-lg-row align-items-center">
                        <div
                            ...
                            <div class="col-lg-8">
                                <h1 class="h2 mb-0">Pending Tasks</h1><br>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all" id="myTable">
                                        @foreach($data as $index => $tasks)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $tasks->intern_first_name }} {{ $tasks->intern_last_name }}</td>
                                            <td>{{ $tasks->level_name }}</td>
                                            <td>{{ $tasks->created_at->format('d-m-Y') }}</td>
                                            <td>{{ $tasks->first_name }} {{ $tasks->last_name }}</td>
                                        @if($tasks->approve == 0)
                                        ...
                                        @endif
                                            ...
                                            <td> <button style="border-color: white; border: none; color:#1E90FF" 
                                                    onClick="window.location.href = '{{ env('APP_URL') }}get_descriptive_by_id/<?php echo $tasks->id; ?>'"><svg
