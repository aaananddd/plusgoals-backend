                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <form method="POST"
                                    action="{{ url('SaveEditQuestions/'.$task_id.'/'. $currentQuestion.'/'.$currentQuestionId)}}">
                                        ...
                                        <div class="card-body table--elevated">
                                            <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-md-1">
                                                        <input id="answerA" name="answer" value="a" type="radio" class="form-control" @if($questions->answer == "a") checked @endif>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body table--elevated">
                                            <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-md-1">
                                                        <input id="answerB" name="answer" value="b" type="radio" class="form-control" @if($questions->answer == "b") checked @endif>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body table--elevated">
                                            <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-md-1">
                                                        <input id="answerC" name="answer" value="c" type="radio" class="form-control" @if($questions->answer == "c") checked @endif>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body table--elevated">
                                        <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                            <div class="form-row align-items-center">
                                                ...
                                                <div class="col-md-1">
                                                    <input id="answerD" name="answer" value="d" type="radio" class="form-control" @if($questions->answer == "d") checked @endif>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body table--elevated">
                                        <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                            <div class="form-row align-items-center">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" id="OptionE" name="OptionE" value="{!! $questions->e !!}">
                                                </div>
                                                <div class="col-md-1">
                                                    <input id="answerE" name="answer" value="e" type="radio" class="form-control" @if($questions->answer == "e") checked @endif>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function () {
        // Assuming you have jQuery loaded and the value of $questions->answer is set initially

        // Function to update the checkbox based on the answer value
        function updateCheckbox(answer) {
            // Remove checked attribute from all checkboxes
            $('input[type="checkbox"]').removeAttr('checked');
            // Check the checkbox corresponding to the answer
            $('#answer' + answer.toUpperCase()).prop('checked', true);
        }

        // Call the function initially to set the checkbox based on the initial answer value
        updateCheckbox('{!! $questions->answer !!}');

        // Update the checkbox when the answer value changes (e.g., through user interaction)
        $('#OptionD, #OptionE').on('input', function () {
            // Assuming the answer value is updated when the input changes
            var newAnswer = $('#OptionD').val().trim() === '' ? 'e' : 'd';
            updateCheckbox(newAnswer);
        });
    });
</script>
