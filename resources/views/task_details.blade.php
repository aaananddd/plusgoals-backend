                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group ">
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-md-3">
                                                        <span style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: bold; color: #333;">Level : </span>
                                                        <span style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: light; color: #333;"> {{ $task->level_name }}</span>
                                                    </div>

                                                    <div class="col-md-3">
                                                        <span style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: bold; color: #333;">Difficulty Level : </span>
                                                        <span style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: light; color: #333;"> {{ $task->difficulty }}</span>
                                                    </div>

                                                    <div class="col-md-3">
                                                        <span style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: bold; color: #333;">Task Category : </span>
                                                        <span style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: light; color: #333;"> {{ $task->category_name }}</span>
                                                    </div>

                                                    <div class="col-md-3">
                                                        <span style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: bold; color: #333;">Module : </span>
                                                        <span style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: light; color: #333;"> {{ $task->module_name }}</span>
                                                    </div>
            ...
            <div class="page-section border-bottom-2" style="background-color:white;">
                <div class="container page__container">
                    ...
                    <span style="font-family: 'Arial', sans-serif; font-size: 16px; color: #333; font-weight:bold;">  Questions : </span>
                        <div class="col-lg-12">
                        <span style="font-family: 'Arial', sans-serif; font-size: 16px; color: #333;"> {!! ($questions->question) !!} </span>
                        </div>
