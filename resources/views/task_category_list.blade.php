...
<title>Task Category List </title>
                    ...
                    <div class="container page__container">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <div class="row align-items-center w-100">
                                ...
                                <div class="ml-lg-4pt" > 
                                    <a href="{{ url('add_new_task_category') }}" class="btn btn-light ml-lg-2" style="color:#1E90FF;">Add new task category</a> 
                                </div>
    ...
    <table class="table align-middle table-nowrap" id="customerTable">
        ...
        @foreach($data as $index => $category)
            ...
            <tr>
                ...
                <td><button style="border-color: white; border: none; color:#1E90FF"  onClick="window.location.href = '{{ env('APP_URL') }}edit_task_category/{{ $category->id }}'">
                    <i class="fa fa-edit" style="font-size:20px"></i>
                    </button>
                </td>
                <td>
                <button style="border-color: white; border: none; color:#1E90FF" onClick="window.location.href = '{{ env('APP_URL') }}deactivate_task_category/{{ $category->id }}'">
