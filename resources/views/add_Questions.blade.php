                                    ...
                                    <div class="card-body table--elevated">
                                        <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                            <div class="form-row align-items-center">
                                                ...
                                                <div class="col-md-1">
                                                    <input id="answer" name="answer" type="radio" value="a"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body table--elevated">
                                        <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                            <div class="form-row align-items-center">
                                                ...
                                                <div class="col-md-1">
                                                    <input id="answer" name="answer" type="radio" value="b"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body table--elevated">
                                        <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                            <div class="form-row align-items-center">
                                                ...
                                                <div class="col-md-1">
                                                    <input id="answer" name="answer" type="radio" value="c"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body table--elevated">
                                        <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                            <div class="form-row align-items-center">
                                                ...
                                                <div class="col-md-1">
                                                    <input id="answer" name="answer" value="d" type="radio"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
