        ...
        <div class="container page__container">
            ...
            <div class="card card-body mb-48pt">
                <div class="form-group row">
                    <label for="module_name" class="col-md-3 col-form-label form-label">Module Name</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="module_name" value="{{ $module['category_name'] }}" readonly>
                    </div>
                </div>

                <div class="form-group row">
                    <label id="label-task_category" for="task_category" class="col-md-3 col-form-label form-label">Task category</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="task_category" value="{{ $module['task_category'] }}" readonly>
                    </div>
                </div>

                <div class="form-group row">
                    <label id="label-" for="topic" class="col-md-3 col-form-label form-label">Topic</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="topic" value="{{ $module['topic'] }}" readonly>
                    </div>
                </div>

                <div class="form-group row">
                    <label id="label-creator" for="creator" class="col-md-3 col-form-label form-label">Created By</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="creator" value="{{ $module['first_name'] }} {{ $module['last_name'] }}" readonly>
                    </div>
                </div>

                <div class="form-group row">
                    <label id="label-parent" for="parent_id" class="col-md-3 col-form-label form-label">Hierarchy</label>
                    <div class="col-md-9">
                        @if (!empty($module['parent']))
                            <ul class="list-unstyled">
                                @php
                                    $parents = collect($module['parent'])->sortBy('id')->values()->all(); // Sort parents by id
                                @endphp
                                @foreach ($parents as $parent)
                                    <li>
                                        <span style="color:black; font-style: italic; border: 1px solid #1E90FF; padding: 10px; display: inline-block; border-radius: 5px; background-color: #f0f8ff;">
