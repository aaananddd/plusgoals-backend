            ...
            <div class="container page__container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form method="POST" action="{{ url('update_task_category') }}/{{ $data->id }}" enctype="multipart/form-data">
                    
                                {{ csrf_field() }}
                                
                                <div class="form-group row">
                                    <label for="old_category_name" class="col-md-3 col-form-label form-label">Old Category Name</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="old_category_name" value="{{ $data->category_name }}" name="old_category_name">
                                    </div>
                                </div>
                                
                                <div class="form-group row">
                                    <label for="new_category_name" class="col-md-3 col-form-label form-label">New Category Name</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="new_category_name" placeholder="Enter new category name ..." name="new_category_name" required>
                                        <span id="title-error" class="error text-danger" style="display:none;">New category name is required.</span> 
                                    </div>
                                </div>
