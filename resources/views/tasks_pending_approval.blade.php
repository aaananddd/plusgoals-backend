            ...
            <div class="mdk-header__content">
                ...
                <div class="navbar navbar-expand navbar-light bg-white border-bottom" id="default-navbar" data-primary>
                    <div class="container page__container">
                        ...
                        <li class="nav-item dropdown ">
                            @if(Session::get('role') == 1)
                            <a href="{{ route('tasksPendingForApproval') }}" class="nav-link {{ Request::route()->getName() == 'tasksPendingForApproval' ? 'active-tab' : '' }}">Pending Approval</a>
                            @endif
                        </li>
                        <li class="nav-item dropdown ">
                ...
                <div class="container page__container">
                    ...
                    <div class="d-flex flex-column flex-lg-row align-items-center">
                        <div
                            ...
                            <h1 class="h2 mb-8pt">Tasks waiting for admin approval</h1>
                        ...
                        <!-- <div class="ml-lg-16pt">
                            ...
                            <a href="{{ route('taskLevel') }}" class="btn btn-light">New task</a>
                        </div> -->
                    </div>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all" id="myTable">
                                        ...
                                        @for ($i = 0; $i < count($task); $i++) <tr>
                                            ...
                                            <td>{{ $task[$i]->difficulty }}</td>
                                            <td>{{ $task[$i]->first_name }} {{ $task[$i]->last_name }}</td>
                                            <td>{{ Carbon\Carbon::parse($task[$i]->created_at )->format('Y-m-d') }}</td>
                                            <td>
                                            <button style="border-color: white; border: none; color:#1E90FF" 
                                            onClick="window.location.href = '{{ env('APP_URL') }}tasks_to_be_approved/<?php echo $task[$i]->task_id; ?>'"><svg
