                ...
                <div class="container page__container">
                    ...
                    <div class="d-flex flex-column flex-lg-row align-items-center">
                        <div
                            ...
                            <div class="col-lg-8">
                                <h1 class="h2 mb-0">Add New User</h1><br>
                                    ...
                                    <div class="form-group">
                                        <div class="card-body table--elevated">
                                            <div class="form-group m-0" role="group" aria-labelledby="label-title">
                                                <div class="form-row align-items-center">
                                                    <label id="label-title" for="task_name"
                                                        class="col-md-3 col-form-label form-label">password</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select class="form-control custom-select w-auto"
                                                            ...
                                                            <option value="{{ $item->id }}">{{ $item->level_name }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <div class="list-group-item">
                                            <div class="text-right">
                                                <button type="submit" style="cursor:pointer" class="btn btn-primary"
                                                    onClick="window.location.href = 'https://admin.plusgoals.com/create_user'">Save</button>
