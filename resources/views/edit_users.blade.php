                ...
                <div class="container page__container">
                    ...
                    <div class="d-flex flex-column flex-lg-row align-items-center">
                        <div
                            ...
                            <div class="col-lg-8">
                                <h1 class="h2 mb-0">Edit User</h1><br>
                                            ...
                                            <div class="form-group m-0" role="group" aria-labelledby="label-topic">
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select class="form-control custom-select w-auto" name="level"
                                                            id="level">
                                                            <!-- <option value="option_select" disabled selected>Select Task Level 
                                                            </option> -->
                                                            @foreach($level as $taskLevel)
                                                            <option value="{{ $taskLevel->id }}" {{ old('task_level',
                                                                $teacher->task_level) ==
                                        ...
                                        <div class="list-group-item">
                                            <div class="text-right">
                                                <button type="submit" style="cursor:pointer" class="btn btn-primary"
                                                    onClick="window.location.href = 'https://admin.plusgoals.com/updateTeacher'">Save</button>
