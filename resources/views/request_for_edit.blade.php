                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="form-row align-items-center"> 
                                                    ...
                                                    <div class="col-md-8"> -->
                                                        <span
                                                            style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: light;color: #333;">
                                                            {{ $task[0]->first_name }} {{ $task[0]->last_name }}</span>
                                                    </div>
                                            </div>
                                            <br>
                                            <div class="form-row align-items-center"> 
                                            ...
                                            <div class="form-row align-items-center"> 
                                                    <div class="col-md-12">
                                                        <span
                                                            style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: bold; color: #333;">
                                                            Currently used by any intern : </span> 
                                                    &nbsp;
                                                    <!-- </div>
                                                    <div class="col-md-8"> -->
                                                        <span
                                                            style="font-family: 'Arial', sans-serif; font-size: 16px; font-weight: light;color: #333;">
                                                            {{ $task[0]->task_assigned }}</span>
                                                    </div>
                                            </div>
                                            <br>
                                            ...
                                            <label>
                                             ...
                                             <button type="button" data-approve="1" data-id="{{ $task[0]->request_id }}" name="submit" id="submit" class="btn btn-primary me-sm-3 me-1 data-submit" style='margin-left:25%' >Approve</button>
                                            </label>
                                            </div>
                    ...
                    <script>
                       jQuery(document).ready(function($) {
                            $("#submit").click(function(e) {
                                ...
                                var request_id =  $('#submit').attr('data-id'); 
                          
                                $.ajax({
                                        type: "POST",
                                        url: "{{ env('APP_URL') }}approve_request_for_edit/" + request_id, 
                                    ...
                                    success: function(data) {
                                        ...
                                        if(data.status === true){
                                            ...
                                            Swal.fire("Failed to approve", "", "danger").then((result) => {
                                            if (result.isConfirmed) {
                                                window.location.href = '/home';
                                            } 
                                           });
...
<script>
    ClassicEditor
        ...
        .then(editor => {
            editor.setData(''); // Use Blade templating to echo the variable
        })
        .catch(error => {
            console.log(error);
        });
