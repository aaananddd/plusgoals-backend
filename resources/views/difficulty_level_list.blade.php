                ...
                <div class="container page__container">
                    <div class="d-flex flex-column flex-lg-row align-items-center">
                        <div
                            ...
                            <div class="col-lg-8">
                                <h1 class="h2 mb-0">Diifficulty Levels</h1><br>
                            </div>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all" id="myTable">
                                        @foreach ($data as $index => $levels)
                                            ...
                                            <td>{{ $levels->no_of_questions }}</td>
                                            <td><button style="border-color: white; border: none; color:#1E90FF" 
                                                 onClick="window.location.href = '{{ env('APP_URL') }}edit_difficulty_level/<?php echo $levels->id; ?>'"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
