                    ...
                    <div class="container page__container">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <div class="row align-items-center w-100">
                                ...
                                <div class="ml-lg-4pt" > 
                                    <a href="{{ route('addNewStudentCategory') }}" class="btn btn-light ml-lg-2" style="color:#1E90FF;">Add new module</a> 
                                </div>
    ...
    <table class="table align-middle table-nowrap" id="customerTable">
        ...
        @foreach($category as $index => $categories)
            <tr>
                ...
                <td>{{ $categories->task_category}}</td>
                <td>{{ $categories->topic }}</td>
                <td>{{ $categories->first_name }} {{ $categories->last_name }}</td>
                <td>{{ Carbon\Carbon::parse($categories->created_at)->format('d-m-Y') }}</td>
                <td class="text-center"> 
                <button style="border-color: white; border: none; color:#1E90FF" onClick="window.location.href = '{{ env('APP_URL') }}show_student_category/{{ $categories->id }}'">
                ...
                <td>
                <button style="border-color: white; border: none; color:#1E90FF" onClick="window.location.href = '{{ env('APP_URL') }}view_student_category/{{ $categories->id }}'">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <td>
                <button style="border-color: white; border: none; color:#1E90FF" onClick="window.location.href = '{{ env('APP_URL') }}deactivate_student_category/{{ $categories->id }}'">
