...
<label id="label-title" for="task_name" class="col-md-3 col-form-label form-label">Course Id</label>
<div class="col-md-9">
...
<textarea id="course_desc" rows="4" class="form-control" name="course_desc"> {{ $course->course_desc }} </textarea>
...
<div class="form-group m-0" role="group" aria-labelledby="label-title">
<div class="form-row align-items-center">
<label id="label-title" for="NoOfQuestns" class="col-md-3 col-form-label form-label">Level</label>
<div class="col-md-9">
<input type="text" class="form-control" id="mode" name="mode" value="{{ $course->level_name }}">
</div>
</div>
</div>
</div>
...
<input type="text" class="form-control" id="topics" name="topics" value="{{ $topic->topics }}"><br>
@endforeach
</div>
</div>
</div>
